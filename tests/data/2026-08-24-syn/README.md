# Synthetic pre-inception snapshot — 2026-08-24-syn

Derived from the frozen `2026-08-24` snapshot by `make_synthetic.py`
...
T-bill fund:  r_t = (1 - 0)*y_(t-1)*d_t/360 - c_b*d_t/365
```
...
series' level exactly. Withholding w = 0 enters the bill accrual
...
|---|---|---|---|---|---|---|---|
| TQQQ — 3x QQQ | 2010-02-11 → 2026-08-20 | 4155 | 1.8970 | 1.8970 | 2.9771 | 17.66 bp | 9.14% |
| BIL — DTB3 accrual | 2007-05-30 → 2026-08-20 | 4837 | 0.1089 | 0.1089 | — | 3.00 bp | 1.13% |

## The splice

| symbol | synthetic rows | first bar | real rows | first real bar | scale |
|---|---|---|---|---|---|
| TQQQ | 2749 | 1999-03-10 | 4158 | 2010-02-11 | 31.863456194235162 |
| BIL | 3609 | 1993-01-29 | 4840 | 2007-05-30 | 40.776088573676994 |
